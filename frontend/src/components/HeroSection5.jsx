      ...
      <div className="hero-section5 flex-row">
        <div className="form-and-head">
         ...
         <div className="contact-details-con">
           <ContactDetails icon={phoneSvg} head={"Phone"} detail={"+923136555641"}/>
           <ContactDetails icon={emailSvg} head={"Email"} detail={"um889943@gmail.com"}/>
           <ContactDetails icon={addressSvg} head={"Adress"} detail={"Affandi Town, Hyderabad sindh"}/>
